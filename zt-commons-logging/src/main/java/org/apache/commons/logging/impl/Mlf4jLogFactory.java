 ...
 * @since 2015-6-10
 */
public class Mlf4jLogFactory extends LogFactory {
...
//        }
        ...
        return new Mlf4jLog( org.zollty.log.LogFactory.getLogger(name) );
    }
    ...
    public void release() {
        ...
        // jcl-over-slf4j.jar.
        System.out.println("WARN: The method " + Mlf4jLogFactory.class + "#release() was invoked.");
